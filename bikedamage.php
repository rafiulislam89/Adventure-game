...
<body class="body">
  <center>
    ...
    <div  id="myDIV">
        <center><h2 id="borderimg1" c style="color:black;">Great Choice Hopefully<br>   
         Your bike is running<br> 
         Shit...bike tier get damage<br>
        ...
        <textarea hidden="hidden" id="text" cols="0" rows="0" style="font-size:0px;background-color:#192841;border-radius: 0px;border-color: #192841;" >
          Great Choice Hopefully   
          Your bike is running 
          Shit...bike tier get damage
...
<div class="container">
    ...
    <div class ="item1" >
        ...
        <div class="card">
            <img src="uiuFile/bike_sit.png" alt="Denim Jeans" style="width:100%;height: 50vh;">
            <h1 class="rickshaw">Wait</h1>
           
            <form method="get" action="waitb.html">
