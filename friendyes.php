...
?>
  <center>
    ...
    <div  id="myDIV">
        <center><h2 id="borderimg1" style="color: black;"> Nice "Helpfull Personal !!!" ...<br>   
            Now Going towards University   <br>
          Wait a Minute !!!<br> 
          Your friend need some snacks for leisure period..<br>
Want to wait for him??<br>
        ...
        <textarea hidden="hidden" id="text" cols="0" rows="0" style="font-size:0px;background-color:#192841;border-radius: 0px;border-color: #192841;" >
          Nice Helpfull Personal 
          Now Going towards University 
        Wait a Minute
        Your friend need some snacks for leisure period
...
<div class="container">
    ...
    <div class ="item1" style="margin-left: 150px;">
        ...
        <div class="card">
            <img src="uiuFile/r_y_1.png" alt="Denim Jeans" style="width:85%;height: 50vh;">
            <h1 class="rickshaw">YES</h1>
...
<div class ="item2" style="margin-right: 150px;">
    ...
    <div class="card">
        <img src="uiuFile/r_y_2.png" alt="Denim Jeans" style="width:100%;height: 50vh;">
        <h1 class="rickshaw">No</h1>
        
        <form method="post" action="">
            <button  type="submit" name="submit2" class="glow-on-hover" class="button">PICK</button>
        </form>
      </div>
