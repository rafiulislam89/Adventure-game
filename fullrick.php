...
<body class="body">
 ...
 <script src="timer.js"></script>
    ...
    <div  id="myDIV">
        <center><h2 id="borderimg1" style="color: gold;"> Hmm!!!  Nice Time is Short ...<br>  
         
         Anyway,,In front of you one friend is calling from the bike <br>
         Want to share his ride for reach the class in time?? <br>
        ...
        <textarea hidden="hidden" id="text" cols="0" rows="0" style="font-size:0px;background-color:#192841;border-radius: 0px;border-color: #192841;" >
          Hmm!  Nice Time is Short  
         
          Anyway In front of you one friend is calling from the bike 
          Want to share his ride for reach the class in time
           </textarea>
...
<div class="container">
    ...
    <div class ="item1" style="margin-left: 150px;">
        ...
        <div class="card">
            ...
            <form method="get" action="needhelp.html">
...
<div class ="item2" style="margin-right: 150px;">
    ...
    <div class="card">
        ...
        <form method="get" action="nobike.html">
            <button style="width:85%;" type="submit" class="button">PICK</button>
        </form>
      </div>
