  ...
  <center>
    ...
    <div  id="myDIV">
        <center><h2 id="borderimg1">   
           You have lost 5 Minutes for helping him  <br>
      
          You are late to reach the class in time.....<br>
          Don't worry Absent is better than helping.....
        ...
        <textarea hidden="hidden" id="text" cols="0" rows="0" style="font-size:0px;background-color:#192841;border-radius: 0px;border-color: #192841;" >
          You have lost 5 Minutes for helping him 
