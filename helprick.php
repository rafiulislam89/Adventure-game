...
?>
  <center>
    ...
    <div  id="myDIV">
        <center><h2 id="borderimg1" style="color: black;"> Hmm!!! Good ...<br>  
        
          In front of you one friend is calling from the bike <br>
        ...
        <textarea hidden="hidden" id="text" cols="0" rows="0" style="font-size:0px;background-color:#192841;border-radius: 0px;border-color: #192841;" >
          Hmm! Good 
          Helping an needed person is too good  
          God will always help that person who helped others 
          In front of you one friend is calling from the bike 
