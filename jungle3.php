...
<head>
    ...
    <title>Jungle Book - Mowgli & Shanti</title>
...
if(isset($_POST['submit'])){
  $username=$_GET['username'];
  $url="jungle4.php?username=".$username;
header('location: '.$url);
}
...
?>
  <center>
   ...
   <!-- <p id="demo"> </p> -->
    ...
    <div  id="myDIV">
        <center>
          <h2 id="borderimg1" style="color: rgb(0, 116, 224);">Shanti is waiting for Mowgli at the river bank <br>
            Mowgli has to reach there to help Shanti<br>
          ...
          <textarea hidden="hidden" id="text" cols="0" rows="0" style="font-size:0px;background-color:#192841;border-radius: 0px;border-color: #192841;" >
                  Shanti is waiting for Mowgli at the river bank. Mowgli has to reach there, to help Shanti
</textarea> 
    ...
    <div class="container">
        ...
        <div class ="item1">
            ...
            <div class="card2">
                <img src="jungleCSS/m_s.png" alt="Denim Jeans" style="width:100%;height: 70vh;">
