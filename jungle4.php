...
<head>
    ...
    <title>Jungle Book - Level 1</title>
...
if(isset($_POST['submit'])){
  $username=$_GET['username'];
  $url="jungle5.php?username=".$username;
header('location: '.$url);
}
...
?>
  <center>
   ...
   <!-- <p id="demo"> </p> -->
    ...
    <div  id="myDIV">
        <center>
          <h2 id="borderimg1" style="color: rgb(0, 116, 224);">Oooops! Looks like snake Kaa is trying to attack Mowgli
            <br>
            What should Mowgli do??<br>
          ...
          <textarea hidden="hidden" id="text" cols="0" rows="0" style="font-size:0px;background-color:#192841;border-radius: 0px;border-color: #192841;" >
            Oooops! Looks like snake Kaa is trying to attack Mowgli. What should Mowgli do??
</textarea> 
    ...
    <div class="container">
        ...
        <div class ="item1">
            ...
            <div class="card">
                <img src="jungleCSS/41.png" alt="Denim Jeans" style="width:100%;height: 50vh;">
                <h1 id="rick"  class="rickshaw">Kaa the Snake</h1>
              </div>
    ...
    <div class ="item2">
        ...
        <div class="card">
            <img src="jungleCSS/42.webp" alt="Denim Jeans" style="width:100%;height: 50vh;">
            <h1 id="bus" class="bus">Wait!!!</h1>
            ...
            <div class ="item3">
                <div class="card">
                    <img src="jungleCSS/43.png" alt="Denim Jeans" style="width:100%;height: 50vh;">
                    <h1 id="bike"  class="rickshaw">Slide!!</h1>
