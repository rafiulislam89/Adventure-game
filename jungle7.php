...
<head>
    ...
    <title>Jungle Book - Game Over</title>
...
?>
  <center>
   ...
   <!-- <p id="demo"> </p> -->
    ...
    <div  id="myDIV">
        <center>
          <h2 id="borderimg1" style="color: rgb(0, 116, 224);">Yayy !! You have helped mogwli to reach shanti!!<br>
          ...
          <textarea hidden="hidden" id="text" cols="0" rows="0" style="font-size:0px;background-color:#192841;border-radius: 0px;border-color: #192841;" >
                                                Yay! You have helped mogwli to reach shanti!
        </textarea>  
    ...
    <div class="container">
        ...
        <div class ="item1">
            ...
            <div class="card5">
                <img src="jungleCSS/7.png" alt="Denim Jeans" style="width:100%;height: 70vh;">
                <h1 id="rick"  class="rickshaw">Congratulations! You Won!</h1>
