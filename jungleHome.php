...
<head>
    ...
    <title>Jungle Book - Mowgli</title>
...
if(isset($_POST['submit'])){
  $username=$_GET['username'];
  $url="jungle2.php?username=".$username;
header('location: '.$url);
}
...
?>
  ...
  <center>
   ...
   <!-- <p id="demo"> </p> -->
    ...
    <div  id="myDIV">
        <center>
          <h2 id="borderimg1" style="color: rgb(0, 116, 224);">This is Mowgli<br>
            The boy who lives in the jungle<br>
            He has some friends in the wild
          ...
          <textarea hidden="hidden" id="text" cols="0" rows="0" style="font-size:0px;background-color:#192841;border-radius: 0px;border-color: #192841;" >
                            This is Mowgli. The boy who lives in the jungle. He has some friends in the wild
        </textarea>  
    ...
    <div class="container">
        ...
        <div class ="item1">
            ...
            <div class="card1">
                <img src="jungleCSS/1.png" alt="Denim Jeans" style="width:100%;height: 70vh;">
                <h1 id="rick"  class="rickshaw">Mowgli</h1>
