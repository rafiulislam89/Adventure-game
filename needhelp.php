...
if(isset($_POST['submit'])){
  ...
  $url="sheet.php?username=".$username;
header('location: '.$url);
}
if(isset($_POST['submit2'])){
  $username=$_GET['username'];
  $url="nosheet.php?username=".$username;
header('location: '.$url);
}
?>
  <center>
    ...
    <div  id="myDIV">
        <center><h2 id="borderimg1" style="color: black;"> Good You are in the campus<br>  
          But hopefully no <br>  
          Your friend is requesting you for a help <br>
          It will take some times..<br>
          You will have to pass the sheet to one of your friend<br>
        ...
        <textarea hidden="hidden" id="text" cols="0" rows="0" style="font-size:0px;background-color:#192841;border-radius: 0px;border-color: #192841;" >
          Good You are in the campus  
          But hopefully no 
          Your friend is requesting you for a help
          It will take some times
          You will have to pass the sheet to one of your friend
        
          Want to help him?      </textarea>
...
<div class="container">
    ...
    <div class ="item1" style="margin-left: 150px;">
        ...
        <div class="card">
            <img src="uiuFile/group.png" alt="Denim Jeans" style="width:100%;height: 50vh;">
            <h1 style="margin-top: 30px;" class="rickshaw">Take Sheet</h1>
...
<div class ="item2" style="margin-right: 150px;">
    ...
    <div class="card">
        <img src="uiuFile/r_y_2.png" alt="Denim Jeans" style="width:85%;height: 50vh;">
        <h1 style="margin-top: 30px;" class="rickshaw">Refuse</h1>
