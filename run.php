...
if(isset($_POST['submit'])){
  $username=$_GET['username'];
  $url="needhelp.php?username=".$username;
header('location: '.$url);
}
...
?>
 ...
 <script src="timer.js"></script>
    ...
    <div  id="myDIV">
        <center><h2 id="borderimg1" style="color: gold;"> Hmm!!!  Nice Choice ...<br>  
          But taking water is more needed for you <br>  
          Anyway,,In front of you one friend is calling from the bike <br>
        Want to share his ride?? <br>
        ...
        <textarea hidden="hidden" id="text" cols="0" rows="0" style="font-size:0px;background-color:#192841;border-radius: 0px;border-color: #192841;" >
          Hmm! Nice Choice  
          But taking water is more needed for you   
          Anyway In front of you one friend is calling from the bike
        Want to share his ride?   </textarea>
...
<div class="container">
    ...
    <div class ="item1" style="margin-left: 150px;">
        ...
        <div class="card">
            <img src="uiuFile/ride_share.png" alt="Denim Jeans" style="width:100%;height: 50vh;">
