...
?>
  <center>
    ...
    <div  id="myDIV">
        <center><h2 id="borderimg1"  style="color: black;">Ohhh...<br>   
           You have lost 2 Minutes for waiting  <br>
         Your vehicle is again running after waiting<br> 
         Hey Look There is an old woman begging for help<br>
         Want to help??
        ...
        <textarea hidden="hidden" id="text" cols="0" rows="0" style="font-size:0px;background-color:#192841;border-radius: 0px;border-color: #192841;" >
          Ohhh  
           You have lost 2 Minutes for waiting 
         Your vehicle is again running after waiting
         Hey Look There is an old woman begging for help
         Want to help?
       </textarea>
...
<div class="container">
    ...
    <div class ="item1" style="margin-left: 150px;" >
        ...
        <div class="card">
            <img src="uiuFile/r_y_y_1_1.png" alt="Denim Jeans" style="width:100%;height: 50vh;">
            <h1 class="rickshaw">Helped Woman</h1>
...
<div class ="item2"  style="margin-right: 150px;">
    ...
    <div class="card">
        <img src="uiuFile/r_y_y_1_2.png" alt="Denim Jeans" style="width:90%;height: 50vh;">
        <h1 class="rickshaw">Refuse Woman</h1>
