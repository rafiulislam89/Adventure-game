...
if(isset($_POST['submit'])){
  $username=$_GET['username'];
  $url="waittraffic.php?username=".$username;
header('location: '.$url);
}
  ...
  <center>
    ...
    <div  id="myDIV">
        <center><h2 id="borderimg1" style="color: black;">You have lost 2 minutes<br>  
          But if you move on,it will be more time consuming.<br>  
          Anyway,,Now Getting Relaxed!!   <br>
          
          Hold on ..There is a huge traffic<br>
        ...
        <textarea hidden="hidden" id="text" cols="0" rows="0" style="font-size:0px;background-color:#192841;border-radius: 0px;border-color: #192841;" >
          ...
          But if you move on it will be more time consuming 
          Anyway Now Getting Relaxed
          
          Hold on There is a huge traffic
          What will you do now
       </textarea>
...
<div class="container">
    ...
    <div class ="item1" style="margin-left: 150px;">
        ...
        <div class="card">
            <img src="uiuFile/jam.png" alt="Denim Jeans" style="width:100%;height: 50vh;">
